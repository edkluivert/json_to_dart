...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      B.DivElement_methods.addEventListener$2($.$get$btnClose(), "click", new A.main_closure0());
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "btnClose", "$get$btnClose", () => A.findType("DivElement")._as(A.querySelector("#close")));
  })();
